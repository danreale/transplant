...
df = pd.read_csv("WaitingListAdult.csv")
...
# if num_rows != 756:
#     raise Exception("Incorrect Number of rows added", num_rows, "Should be 756")
...
# rename heart status values:
df["wait_list_type"] = df["wait_list_type"].replace(
    {
        "Heart: Adult Status 1": "Adult Status 1",
        "Heart: Adult Status 2": "Adult Status 2",
        "Heart: Adult Status 3": "Adult Status 3",
        "Heart: Adult Status 4": "Adult Status 4",
        "Heart: Adult Status 5": "Adult Status 5",
        "Heart: Adult Status 6": "Adult Status 6",
    },
)
